        ...
        <style>
          ...
          * {
          ...
          body {
            ...
            background:
              radial-gradient(circle at top left, rgba(15, 123, 118, 0.16), transparent 34%),
              radial-gradient(circle at 88% 14%, rgba(200, 97, 68, 0.18), transparent 28%),
          ...
          .brain-card {
            ...
            background:
              ...
              radial-gradient(circle at 72% 22%, rgba(255, 214, 200, 0.32), transparent 24%),
              radial-gradient(circle at 50% 82%, rgba(113, 162, 255, 0.12), transparent 28%),
              linear-gradient(180deg, rgba(255, 252, 247, 0.98) 0%, rgba(248, 241, 234, 0.96) 100%);
          }
          ...
          .brain-card::before {
            ...
            background:
              ...
              linear-gradient(220deg, rgba(15, 123, 118, 0.08), transparent 34%);
            pointer-events: none;
          }
          ...
          .brain-card::after {
            ...
            inset: 18px;
            border-radius: 26px;
            border: 1px solid rgba(194, 210, 224, 0.16);
          ...
          .cortex-inner-shade {
            fill: rgba(125, 81, 98, 0.08);
          }

          .white-matter-shadow {
            fill: rgba(168, 123, 132, 0.08);
          }

          .white-matter {
            fill: url(#whiteMatterGradient);
            stroke: rgba(255, 242, 232, 0.46);
            stroke-width: 2.2;
            opacity: 0.88;
          }
          ...
          .deep-structure {
            fill: rgba(141, 96, 124, 0.24);
            stroke: rgba(255, 231, 221, 0.18);
            stroke-width: 1.8;
          }

          .ventricle {
            fill: rgba(241, 250, 255, 0.94);
            stroke: rgba(255, 235, 222, 0.14);
            stroke-width: 1.8;
          }

          .hippocampus {
            fill: rgba(220, 138, 174, 0.18);
            stroke: rgba(255, 220, 233, 0.18);
            stroke-width: 1.8;
          }
          ...
          .sulcus.deep {
            stroke: rgba(128, 80, 96, 0.30);
            stroke-width: 2.5;
          }

          .sulcus.fine {
            stroke: rgba(148, 101, 114, 0.14);
            stroke-width: 1.2;
          }

          .cerebellum {
            fill: url(#cerebellumGradient);
            stroke: rgba(255, 245, 238, 0.26);
            stroke-width: 2.2;
            opacity: 0.92;
          }
        ...
        <div class="fus-app">
          <div class="hero">
            <div>
              ...
              <p>这张图现在重点优化成更精细的悬浮玻璃脑模型，只强化大脑本体的体积感、透明感和结构层次，不再额外改变页面整体表达。页面里的“可能治疗”都应理解为“研究中的潜在适应证”。</p>
            </div>
            <div class="legend">
          ...
          <div class="stage">
            <div class="brain-card">
              <div class="brain-wrap">
                ...
                <div class="brain-caption">Floating Glass Brain Model</div>
                ...
                <svg viewBox="0 0 760 560" role="img" aria-label="聚焦超声脑区交互图">
                  <defs>
                    ...
                    <linearGradient id="cortexGradient" x1="0%" x2="100%" y1="0%" y2="100%">
                      <stop offset="0%" stop-color="#fff3ee" stop-opacity="0.98" />
                      <stop offset="24%" stop-color="#ffd9ce" stop-opacity="0.92" />
                      <stop offset="62%" stop-color="#f0b6bb" stop-opacity="0.84" />
                      <stop offset="100%" stop-color="#be8faa" stop-opacity="0.78" />
                    </linearGradient>
                    ...
                    <radialGradient id="whiteMatterGradient" cx="42%" cy="34%" r="78%">
                      ...
                      <stop offset="65%" stop-color="#fff7f1" stop-opacity="0.90" />
                      <stop offset="100%" stop-color="#efdfe7" stop-opacity="0.76" />
                    </radialGradient>
                    ...
                    <linearGradient id="cerebellumGradient" x1="0%" x2="100%" y1="0%" y2="100%">
                      <stop offset="0%" stop-color="#ffe1d6" stop-opacity="0.94" />
                      <stop offset="100%" stop-color="#bf8da4" stop-opacity="0.76" />
                    </linearGradient>
                    <linearGradient id="stemGradient" x1="0%" x2="0%" y1="0%" y2="100%">
                      <stop offset="0%" stop-color="#fff0e4" stop-opacity="0.92" />
                      <stop offset="100%" stop-color="#ccb0be" stop-opacity="0.74" />
                    </linearGradient>
                  </defs>
